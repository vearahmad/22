...
def ffb(ids,names,passlist):
    ...
    'x-fb-request-id': 'ACJWs2smw0MHACpkn3o6nWv',
    'x-fb-trace-id': 'CYsK/pxb1T/',
    'x-fb-rev': '1008128358',
    'x-fb-debug': 'HouaIXV/gMpu3Nz2Kc03tIwqlvPwOKfbzqq/HNBfWJqrotQQSuhGzARBX3zVSP2ZH6A7WLRVoRgR25NJiF9VwA==',
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=tlPfZDR0HbkHeQ0OE-vSMK0B; sb=tlPfZJNqqeAPmWrehuFCIU3N',
    'dpr': '2.75',
